export function ReturnSkins() {
    const skinsSrc = [
        ...
        { src: 'assets/BenSkins/BreiterBen.png', description: "B(e)reiter Ben" },
        { src: 'assets/BenSkins/DoenerLeanBen.png', description: "Döner Lean Ben" },
        { src: 'assets/BenSkins/MuayThaiBen.png', description: "Muay Thai Kämpfer Ben" },
